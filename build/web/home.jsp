					...
					<div class="card card-primary" style="margin-top: 12px;">
						...
						<div style="margin-top: 12px; margin-left: 12px;">
							...
							<ol style="text-align: left;">
								...
								<li>Muốn chỉnh sửa thông tin loại mặt hàng nào thì bấm nút <b>Chỉnh
										sửa</b>-&gt; Chỉnh sửa những thông tin cần thiết-&gt; Nhấn <b>Lưu-</b>&gt;
									nhấn <b>Hủy</b> để trở lại danh sách.
								</li>
								<li>Muốn xóa loại mặt hàng nào thì bạn chọn nút <b>Xóa</b> tương ứng
									của loại mặt hàng đó . Có thông báo xác nhận hiện ra. Chọn <b>Xóa</b> để
							...
							<p>
								- Muốn thêm mặt hàng thì chọn&nbsp;<b>Quản lý loại mặt hàng -&gt; Thêm
									loại mặt hàng -&gt; </b>Điền những thông tin cần thiết , chọn danh mục sản phẩm
                                                                        tương ứng-&gt; Nhấn <b>Lưu</b> để lưu lại và nhấn <b>Hủy</b>
								để trở lại danh sách.
							</p>
							<p>
								-Muốn xem danh mục sản phẩn thì chọn&nbsp;<b>Quản lý loại mặt hàng -&gt;
									Danh mục sản phẩm.</b>
							</p>
							<p>-Trong mục danh mục sản phẩm, muốn thêm danh mục sản phẩm thì chọn thêm thể
								danh mục sản phẩm, muốn chỉnh sửa chọn chỉnh sửa, muốn xóa thì chọn nút Xóa.</p>
							<p>
