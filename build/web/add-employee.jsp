                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <form role="form" method="post" id="createForm"
                              action="${pageContext.request.contextPath}/add-employee"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label>Vị trí <span style="color: red">&nbsp;*</span></label> <select name="position" id="position"
                                        ...
                                        <option value="${Integer.toString(positions.get("SALES"))}">Nhân viên bán hàng</option>
                                        <option value="${Integer.toString(positions.get("CUSTOMER_CARE"))}">Chăm sóc khách hàng</option>
                                        <option value="${Integer.toString(positions.get("WAREHOUSE"))}">Nhân viên kho</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>Ngày ký hợp đồng <span style="color: red">&nbsp;*</span></label> 
                                    <input type="date" onchange="handleChangeContractStart()" class="form-control" id="contract_start_at" name="contract_start_at">
                                    <div style="color: red" id="validateStart"></div>
                                </div>
                                <div class="form-group">
                                    <label>Ngày kết thúc hợp đồng <span style="color: red">&nbsp;*</span></label> 
                                    <input type="date" onchange="handleChangeContractEnd()" class="form-control" id="contract_end_at" name="contract_end_at">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <label class="switch">
                                            <input class="status-input" type="checkbox" checked id="status" name="status" onchange="handleChangeTooltip()">
                                            <span class="slider round"></span>
                                            <span class="tooltiptext">Đang hoạt động</span>
                                        </label>
                                    </div>
                                </div>
                            </div>
