...
CREATE TABLE `hoadonmh` (
  ...
  CONSTRAINT `fk_book_id` FOREIGN KEY (`idMH`) REFERENCES `product` (`id`),
...
INSERT INTO `product` VALUES (73,'Thịt heo',34,1,'thitheo.png','2024-02-28 06:57:53','100000'),(74,'Thịt bò',34,1,'thitbo.png','2024-02-28 06:58:27','150000'),(75,'Trái cây',35,1,'traicay.png','2024-02-28 07:00:32','50000'),(76,'Rau lá',35,1,'raula.png','2024-02-28 07:05:04','10000'),(77,'Thịt gà',34,1,'thitbo.png','2024-02-28 06:58:27','60000');
...
CREATE TABLE `reader` (
  ...
  PRIMARY KEY (`id`),
  KEY `book_id` (`book_id`),
  CONSTRAINT `reader_ibfk_1` FOREIGN KEY (`book_id`) REFERENCES `product` (`id`)
...
-- Dump completed on 2024-05-07 22:30:17
